...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url:
                "https://github.com/moonshine-ai/moonshine-swift/releases/download/v0.0.61/Moonshine.xcframework.zip",
            checksum: "e5bfe876c7e526a91d514cd12719c1d635261b1e5ac83ff1a5a55d21ed395c47"
        ),
        .target(
            name: "MoonshineVoice",
