...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url:
                "https://github.com/moonshine-ai/moonshine-swift/releases/download/v0.0.33/Moonshine.xcframework.zip",
            checksum: "e266b1a4b2e83c150172db3dfdd195464d023d59d574927c05d95c60791e5d22"
        ),
        .target(
            name: "MoonshineVoice",
