...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url:
                "https://github.com/moonshine-ai/moonshine-swift/releases/download/v0.0.55/Moonshine.xcframework.zip",
            checksum: "3426d36e55bcbdc7f5fd36af7160952087d33544a9cec8d884a7a743f104043d"
        ),
        .target(
            name: "MoonshineVoice",
