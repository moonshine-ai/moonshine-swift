...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url:
                "https://github.com/moonshine-ai/moonshine-swift/releases/download/v0.0.73/Moonshine.xcframework.zip",
            checksum: "4ef0e189ebe03fc81e5a404f3f0d02d58d29c88acc9d7f19a9d9f94312f05723"
        ),
        .target(
            name: "MoonshineVoice",
