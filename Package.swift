...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url:
                "https://github.com/moonshine-ai/moonshine-swift/releases/download/v0.1.0/Moonshine.xcframework.zip",
            checksum: "a967095a1ff4184df31457626ff3cfa220c18c1267741b716a671ca91734bb2b"
        ),
        .target(
            name: "MoonshineVoice",
