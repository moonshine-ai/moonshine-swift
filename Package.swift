...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url:
                "https://github.com/moonshine-ai/moonshine-swift/releases/download/v0.0.20/Moonshine.xcframework.zip",
            checksum: "9fa796033bdf56d419923dd0ec0b8277fcf2b5a33dc179623d36b6d46032e671"
        ),
        .target(
            name: "MoonshineVoice",
