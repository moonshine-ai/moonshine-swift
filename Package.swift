...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url:
                "https://github.com/moonshine-ai/moonshine-swift/releases/download/v0.0.67/Moonshine.xcframework.zip",
            checksum: "71cd2d75b84b8375ff17f6d7531c70cfe79b2ad3c84e73ab7ea0c46fa5a8acd2"
        ),
        .target(
            name: "MoonshineVoice",
