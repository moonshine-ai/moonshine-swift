...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url:
                "https://github.com/moonshine-ai/moonshine-swift/releases/download/v0.0.36/Moonshine.xcframework.zip",
            checksum: "3ccd4d10bfb20be891acc320d0b997367e5be3653bf51fbda81cbb348d1ab5f8"
        ),
        .target(
            name: "MoonshineVoice",
