...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url:
                "https://github.com/moonshine-ai/moonshine-swift/releases/download/v0.0.41/Moonshine.xcframework.zip",
            checksum: "c8df9b0d851ae73564b25c8e45751ada6f6df800c23921fe951406852107a4be"
        ),
        .target(
            name: "MoonshineVoice",
