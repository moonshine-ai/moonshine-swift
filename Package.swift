...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url:
                "https://github.com/moonshine-ai/moonshine-swift/releases/download/v0.0.43/Moonshine.xcframework.zip",
            checksum: "ae656bcfeca1c7d7992c9804b10206f82a3d6c25057c3e5d37988b556a21e8f8"
        ),
        .target(
            name: "MoonshineVoice",
