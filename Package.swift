...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url:
                "https://github.com/moonshine-ai/moonshine-swift/releases/download/v0.0.30/Moonshine.xcframework.zip",
            checksum: "718fd301d6ee108cde2af48a593f14bf5f47d59398442e4d9ec700bef3f724c5"
        ),
        .target(
            name: "MoonshineVoice",
