...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url:
                "https://github.com/moonshine-ai/moonshine-swift/releases/download/v0.0.28/Moonshine.xcframework.zip",
            checksum: "cd82b916a990bc32c31eab8be5fce694d5a4fed1ea1e99b5b3e96893b7403796"
        ),
        .target(
            name: "MoonshineVoice",
