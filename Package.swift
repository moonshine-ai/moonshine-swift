...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url:
                "https://github.com/moonshine-ai/moonshine-swift/releases/download/v0.0.31/Moonshine.xcframework.zip",
            checksum: "50d913a07d6eb92653962ebe0f82296484f10479fb05775dfbd87172bdbb6fb1"
        ),
        .target(
            name: "MoonshineVoice",
