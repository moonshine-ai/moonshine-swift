...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url:
                "https://github.com/moonshine-ai/moonshine-swift/releases/download/v0.0.52/Moonshine.xcframework.zip",
            checksum: "ad28edd35f3de432c0740ba63738c7e7072dc7e8f083846ecabe6959951ce756"
        ),
        .target(
            name: "MoonshineVoice",
