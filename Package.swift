...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url:
                "https://github.com/moonshine-ai/moonshine-swift/releases/download/v0.0.68/Moonshine.xcframework.zip",
            checksum: "96d4255cd87d4035b90815847431e2a6ac7a82729fabb48c96b860c9e06cd417"
        ),
        .target(
            name: "MoonshineVoice",
