...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url:
                "https://github.com/moonshine-ai/moonshine-swift/releases/download/v0.0.29/Moonshine.xcframework.zip",
            checksum: "32daa7e52c76da39a99763233641c749aab5ffa44346c8971db807e0d61bf8ee"
        ),
        .target(
            name: "MoonshineVoice",
