...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url:
                "https://github.com/moonshine-ai/moonshine-swift/releases/download/v0.0.32/Moonshine.xcframework.zip",
            checksum: "607c7258c38ab61fbd3542fb0a909f38cb8054d7b8873ecb09b79a63be2c611e"
        ),
        .target(
            name: "MoonshineVoice",
