...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url:
                "https://github.com/moonshine-ai/moonshine-swift/releases/download/v0.0.63/Moonshine.xcframework.zip",
            checksum: "ed6fae374d17ee49149ca2518501957b6c88662d607eac806ac7e916fd55e34f"
        ),
        .target(
            name: "MoonshineVoice",
