...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url:
                "https://github.com/moonshine-ai/moonshine-swift/releases/download/v0.0.69/Moonshine.xcframework.zip",
            checksum: "953f852898461d5d0bc18765ca48aa35944f41882b91b3921980c19481319743"
        ),
        .target(
            name: "MoonshineVoice",
