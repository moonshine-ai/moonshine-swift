...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url:
                "https://github.com/moonshine-ai/moonshine-swift/releases/download/v0.0.60/Moonshine.xcframework.zip",
            checksum: "6a30b239b7fd4360eadd36c4201066e7f483915843c0f3c3c7d1935b07f6a969"
        ),
        .target(
            name: "MoonshineVoice",
